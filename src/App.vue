      ...
      return [
        {
          key: 'og:image',
          name: 'og:image',
          content: 'https://images.prismic.io/foodculturedays2020/d9b539ae-e7ce-4672-b03c-178088278dfa_FCD2022.jpeg?auto=compress,format'
        },
        {
          key: 'description',
          name: 'description',
  ...
  .home.splash {
    ...
    #splash {
      .image {
        ...
        background-image: url(https://images.prismic.io/foodculturedays2020/d9b539ae-e7ce-4672-b03c-178088278dfa_FCD2022.jpeg?auto=compress,format);
