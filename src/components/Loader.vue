...
export default {
  ...
  mounted () {
    ...
    const curtain = this.$el.childNodes[1]
    const blob = this.$el.childNodes[0].children[0]
    const blobPath = this.$el.childNodes[0].children[0].children[0]
    // const blob = this.$el.childNodes[0]
    // const blobPath = this.$el.childNodes[0].children[0]
